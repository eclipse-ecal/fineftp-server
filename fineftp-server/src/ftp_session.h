...
namespace fineftp
{
  ...
  ////////////////////////////////////////////////////////
  public:
    FtpSession(asio::io_context& io_context, const UserDatabase& user_database, const std::function<void(FtpSession*)>& completion_handler, std::ostream& output, std::ostream& error);
